...
TENS_TABLE = {20: ' TWENTY', 30: ' THIRTY', 40: ' FOURTY', 50: ' FIFTY', 60: ' SIXTY', 70: ' SEVENTY', 80: ' EIGHTY',
              90: ' NINETY'}
CARDINAL_NUMBER = {100: ' HUNDRED', 1000: ' THOUSAND', 1000000: ' MILLION', 1000000000: ' BILLION',
...
def transform(price):
    ...
    wanyi = int(integer / 1000000000000)
    shiyi = int(integer / 1000000000 % 1000)
    baiwan = int(integer / 1000000 % 1000)
    qian = int(integer / 1000 % 1000)
    ge = int(integer % 1000)

    if 0 < wanyi < 1000:
        eng_str = _handle_int_part(wanyi, eng_str)
        eng_str += ' TRILLION'
    elif 1000 <= wanyi < 10000:
        qianwanyi = int(wanyi / 1000)
